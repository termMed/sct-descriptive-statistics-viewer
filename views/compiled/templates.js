...
function program1(depth0,data) {
  ...
  buffer += "<div class=\"col-md-12\">\n    <div class=\"card\">\n        <div class=\"card-height-indicator\"></div>\n        <div class=\"card-content\">\n            <div class=\"card-body\">\n                <h2>Percents of Changes to Existing Concepts by Change Type (*) and Hierarchy</h2>\n                <div class=\"row\">\n                    <div class=\"col-lg-12\">\n                        <div class=\"bs-component\">\n                            <table class=\"table table-striped table-hover \">\n                                <thead>\n                                <tr>\n                                    <th>Hierarchy</th>\n                                    <th>Any</th>\n                                    <th>Stated Defn</th>\n                                    <th>Inferred Defn</th>\n                                    <th>P to SD </th>\n                                    <th>SD to P</th>\n                                    <th>Description Change</th>\n                                    <th>FSN Change</th>\n                                </tr>\n                                </thead>\n                                <tbody>\n                                ";
  stack1 = helpers.each.call(depth0, (depth0 && depth0.rows), {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n                                </tbody>\n                                <tfoot>\n                                <tr class=\"small\"><td colspan=\"8\">(*) Stated Defn = Change to stated concept definition<br>\n                                    Inferred Defn = Change to inferred concept definition<br>\n                                    P to SD = Change in concept definition status from Primitive to Sufficiently Defined<br>\n                                    SD to P = Change in concept definition status Sufficiently Defined to Primitive</td></tr>\n                                </tfoot>\n                            </table>\n                        </div><!-- /example -->\n                    </div>\n                </div>\n            </div>\n            <footer class=\"card-footer\">\n                <!--<button class=\"btn btn-flat\">Share</button>-->\n                <!--<button class=\"btn btn-flat btn-warning\">Learn More</button>-->\n            </footer>\n        </div>\n    </div>\n</div>\n";
  return buffer;
...
function program1(depth0,data) {
  ...
  buffer += "<div class=\"col-md-12\">\n    <div class=\"card\">\n        <div class=\"card-height-indicator\"></div>\n        <div class=\"card-content\">\n            <div class=\"card-body\">\n                <h2>General Release Statistics</h2>\n                <div class=\"row\">\n                    <div class=\"col-lg-12\">\n                        <div class=\"bs-component\">\n                            <table class=\"table table-striped table-hover \">\n                                <thead>\n                                <tr>\n                                    <th>Hierarchy</th>\n                                    <th>Concepts</th>\n                                    <th>% of SCT</th>\n                                    <th>% SD <small>(*)</small></th>\n                                    <th>Descriptions</th>\n                                    <th>Relationships</th>\n                                </tr>\n                                </thead>\n                                <tbody>\n                                ";
  stack1 = helpers.each.call(depth0, (depth0 && depth0.rows), {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n                                </tbody>\n                                <tfoot>\n                                    <tr>\n                                        <td colspan=\"6\">(*) Percentage of existing concepts in hierarchy. For the root concept the value includes all SNOMED CT.<br>\n                                        SD = Sufficiently Defined</td>\n                                    </tr>\n                                </tfoot>\n                            </table>\n                        </div><!-- /example -->\n                    </div>\n                </div>\n            </div>\n            <footer class=\"card-footer\">\n                <!--<button class=\"btn btn-flat\">Share</button>-->\n                <!--<button class=\"btn btn-flat btn-warning\">Learn More</button>-->\n            </footer>\n        </div>\n    </div>\n</div>\n";
  return buffer;
  });
...
function program1(depth0,data) {
  ...
  buffer += "<div class=\"col-md-12\">\n    <div class=\"card\">\n        <div class=\"card-height-indicator\"></div>\n        <div class=\"card-content\">\n            <div class=\"card-body\">\n                <h2>New Concepts Statistics</h2>\n                <div class=\"row\">\n                    <div class=\"col-lg-12\">\n                        <div class=\"bs-component\">\n                            <table class=\"table table-striped table-hover \">\n                                <thead>\n                                <tr>\n                                    <th>Hierarchy</th>\n                                    <th>New concepts</th>\n                                    <th>% new in hierarchy</th>\n                                    <th>% of All new in Release</th>\n                                    <th>% Added as SD (*)</th>\n                                    <th>% Added p (*)</th>\n                                </tr>\n                                </thead>\n                                <tbody>\n                                ";
  stack1 = helpers.each.call(depth0, (depth0 && depth0.rows), {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
...
function program1(depth0,data) {
  ...
  buffer += "<div class=\"col-md-12\">\n    <div class=\"card\">\n        <div class=\"card-height-indicator\"></div>\n        <div class=\"card-content\">\n            <div class=\"card-body\">\n                <h2>Statistics on Concepts Inactivated During the Release</h2>\n                <div class=\"row\">\n                    <div class=\"col-lg-12\">\n                        <div class=\"bs-component\">\n                            <table class=\"table table-striped table-hover \">\n                                <thead>\n                                <tr>\n                                    <th>Hierarchy</th>\n                                    <th>Inactivated Concepts</th>\n                                    <th>% of SCT Inactivated</th>\n                                    <th>% of All Inactivated</th>\n                                    <th>% as Ambiguous</th>\n                                    <th>% as Duplicate</th>\n                                    <th>% as Erroneous</th>\n                                    <th>% as Not Stated</th>\n                                    <th>% as Outdated</th>\n                                    <th>% as Moved</th>\n                                    <th>% as Limited</th>\n                                </tr>\n                                </thead>\n                                <tbody>\n                                ";
  stack1 = helpers.each.call(depth0, (depth0 && depth0.rows), {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n                                </tbody>\n                            </table>\n                        </div><!-- /example -->\n                    </div>\n                </div>\n            </div>\n            <footer class=\"card-footer\">\n                <!--<button class=\"btn btn-flat\">Share</button>-->\n                <!--<button class=\"btn btn-flat btn-warning\">Learn More</button>-->\n            </footer>\n        </div>\n    </div>\n</div>\n";
  return buffer;
